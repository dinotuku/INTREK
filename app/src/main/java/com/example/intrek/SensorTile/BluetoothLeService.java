...
public class BluetoothLeService extends Service {
    ...
    public final static String TEMPERATURE =
            "Tempererature";
    public final static String PRESSURE =
            "Pressure";

    public final static UUID TEMP_PRESSURE_MEASUREMENT =
            UUID.fromString("00140000"+ SampleGattAttributes.BASE_FEATURE_COMMON_UUID);
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            Log.e(TAG,"Inside GattCallback, Connexion:"+newState);
            String intentAction;
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            Log.e(TAG,"Inside GattCallback, service:"+ status);
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
                                         ...
                                         int status) {
            Log.e(TAG,"Inside GattCallback, characteristic:"+ status);
            if (status == BluetoothGatt.GATT_SUCCESS) {
